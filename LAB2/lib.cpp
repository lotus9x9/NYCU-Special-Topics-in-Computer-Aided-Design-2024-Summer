...
{
public:
    double output_cap[7] = {0.001400, 0.003000, 0.006200, 0.012500, 0.025100, 0.050400, 0.101000};
    double input_trans_time[7] = {0.0208, 0.0336, 0.06, 0.1112, 0.2136, 0.4192, 0.8304};

    double nor2_input_cap[2] = {0.0105008, 0.0108106};
    double nor2_rise_time[7][7] = {{0.023104, 0.026347, 0.032439, 0.037211, 0.050187, 0.075629, 0.10893},
    ...
    double nor2_fall_time[7][7] = {{0.017693, 0.020473, 0.024855, 0.029528, 0.03475, 0.038561, 0.030505},
    ...
    double nor2_rise_trans_time[7][7] = {{0.047372, 0.047388, 0.05291, 0.069558, 0.079757, 0.11295, 0.16298},
    ...
    double nor2_fall_trans_time[7][7] = {{0.0178, 0.020672, 0.025912, 0.038106, 0.054758, 0.087109, 0.14053},
    ...
    double inv_input_cap = 0.0109115;

    double inv_rise_time[7][7] = {{0.013379, 0.016044, 0.019907, 0.022481, 0.031726, 0.040185, 0.050385},
    ...
    double inv_fall_time[7][7] = {{0.015975, 0.018648, 0.022904, 0.028037, 0.031885, 0.041402, 0.053623},
    ...
    double inv_rise_trans_time[7][7] = {{0.017522, 0.021682, 0.028803, 0.041672, 0.052872, 0.081109, 0.12837},
    ...
    double inv_fall_trans_time[7][7] = {{0.017349, 0.017893, 0.024178, 0.035104, 0.051821, 0.075654, 0.12316},
    ...
    double nand2_input_cap[2] = {0.00683597, 0.00798456};

    double nand2_rise_time[7][7] = {{0.020844, 0.02431, 0.030696, 0.039694, 0.048205, 0.072168, 0.10188},
    ...
    double nand2_fall_time[7][7] = {{0.020382, 0.023257, 0.027894, 0.033548, 0.03574, 0.04179, 0.044857},
    ...
    double nand2_rise_trans_time[7][7] = {{0.030236, 0.03225, 0.038219, 0.052208, 0.080479, 0.10719, 0.15147},
    ...
    double nand2_fall_trans_time[7][7] = {{0.027802, 0.028745, 0.035327, 0.047243, 0.067704, 0.097889, 0.15165},
